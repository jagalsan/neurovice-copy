...
export async function generateMetadata({ 
  ...
  return await generatePageMetadata(locale as Locale, {
    ...
    descriptionKey: "seo.cookies_description",
  ...
  return (
    <section className="text-white max-w-[1459px] mx-auto px-4 md:px-8">
      ...
      <p className="text-[var(--color-brand-300)] text-sm md:text-base mb-10">
        This Cookies Policy explains how Neurovice LTD ("Neurovice", "Company",
        ...
        information in accordance with this Cookies Policy.
      </p>
      ...
      <p className="mb-12">
        If you have questions about this Cookies Policy or our data practices,
        contact:
        <br />
