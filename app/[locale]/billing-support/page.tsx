...
export async function generateMetadata({ 
  ...
  return await generatePageMetadata(locale as Locale, {
    titleKey: "seo.billing_support_title",
    descriptionKey: "seo.billing_support_description",
  ...
  return (
    <section className="text-white max-w-[1459px] mx-auto px-8">
      ...
      <p className="text-[var(--color-brand-300)] text-sm md:text-base mb-10">
        This Billing Support page explains how Neurovice LTD ("Neurovice", "Company",
